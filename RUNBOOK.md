...
- `./mem0.sh` CLI to manage your long term memory. This is your main long-term memory. Use this to store useful info between trading runs (not specific to any market, but rather general).
